...
pkl_file = '/home/mo/Datasets/11-Leeds/Dukes_modified/experiment/sentences.p'
pickle.dump(sentences_to_test, open(pkl_file, 'wb'))

file1 = '/home/mo/Datasets/11-Leeds/Dukes_modified/experiment/sentences.txt'
F = open(file1, 'w')
...
Data = read_data()
tokens = [str(i) for i in range(50)]
f = open('/home/mo/Datasets/11-Leeds/Dukes_modified/experiment/tags.txt', 'w')
for id in sentences_to_test:
